...
void dijkstra(int verticeInicial)
{
    ...
    while (!colaPrioridad.empty())
    {
        ...
        {                              // no pasamos por este antes
            ...
            cout << carreras[previo[destination]] << " -> ";
...
void print( int destination ){
    ...
    if (previo[ destination ] != -1) {
        cout << carreras[previo[destination]] << " -> "; // mostrar el paso intermedio solo si existe
    }
}
...
int main()
{
    ...
    cout << "Según la lista anterior, añade la carrera de tu interés como punto de partida: ";
